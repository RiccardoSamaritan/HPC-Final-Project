 ...
 *
 */
static void compute_accelerations_third_law (size_t              n,
                                              dtype                g,
                                              dtype                mass,
                                              dtype                eps,
  ...
  if (profiler != NULL)
    {
      ...
      compute_accelerations_third_law (p->n, g, p->mass, eps,
                                   p->x, p->y, p->z,
                                   p->ax, p->ay, p->az);
      t1 = get_time ();
...
int main (int argc, char **argv)
{
  ...
  if (!quiet)
    {
      printf ("# serial direct N-body DKD newton3rd\n");
