 ...
 *
 */
static void compute_accelerations_blocked (size_t              n,          // number of particles
...
#endif
      compute_accelerations_blocked (p->n, g, p->mass, eps,
                                   p->x, p->y, p->z,
                                   p->ax, p->ay, p->az);
#ifdef USE_PAPI
...
int main (int argc, char **argv)
{
  ...
  if (!quiet)
    {
      printf ("# serial direct N-body DKD blocking\n");
